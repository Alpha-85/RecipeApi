...
public class SpoonAdapter : ISpoonAdapter
{
    ...
    public SpoonAdapter(HttpClient httpClient, ILogger<SpoonAdapter> logger, SpoonApiSettings settings)
    {
    ...
    // IOptions<SpoonApiSettings> options
    ...
    public async Task<List<ExtendedIngredient>> GetRecipeIngredientsAsync(long recipeId)
    {
        ...
        var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get,
            $"https://api.spoonacular.com/recipes/{recipeId}/information?includeNutrition=false&apiKey=b87efff8b00e4f22a2f3348ca1b13acb");
        httpRequestMessage.Headers.Add("Accept", "application/json");
